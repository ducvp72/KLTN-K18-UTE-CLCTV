...
module.exports.toJSONM = require('./toJSONM.plugin');
...
module.exports.paginateClient = require('./paginateClient.plugin');
module.exports.paginateUserGroup = require('./paginationUserGroup.plugin');
module.exports.paginateGroup = require('./paginateGroup.plugin');
