          ...
          >
            ...
            <View style={styles.userInfo}>
              ...
              <View style={styles.userMessage}>
                <Text
                  style={[styles.userUsername, { color: theme.colors.text }]}
                >
                  {"@"}
            ...
            {isAdmin ? (
              ...
              >
                <Menu.Item
                  onPress={() => promoteAdmin(item.userId)}
                  title={t("common:promoteAdmin")}
                />
                <Menu.Item
                  onPress={() => deleteMember(item.userId, item.fullname)}
