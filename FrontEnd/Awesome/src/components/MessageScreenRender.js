...
const CustomtInputToolbar = ({props, Gallery, Photo, Video, File, start, stop, del, replay, send, currentLocation}) => {
    ...
    return (
        <View style={styles.recordModeContainer}>
            ...
            <Icon
                ...
                name='microphone'
                size={30}
                style={[styles.recordButton, {color: isRecording ? 'gray' : 'green'}]}
            />
            <Icon
                onPress={() => {
                    if(!isRecording) return
            ...
            <Icon
                ...
                name='trash-alt'
                size={30}
                style={[styles.recordButton, {color: isRecording ? 'gray' : 'black'}]}
            />
            <Text 
...
const renderCustomView = props => {
    ...
    if (props?.currentMessage?.location && props?.currentMessage?.location != 'null') {
        return (
